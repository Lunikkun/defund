    ...
    const createDonation = async()=>{
        try{
            if(parseInt(amount)){
                ...
                console.log(data);
                setAmountError("")
            }else { setAmountError(amount+" non valido"); throw new Error(amount+" non valido")}
        }catch(error){
            console.log(error)
        };
    };   
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full 
                    ...
                    <div className="flex items-start justify-between p-5 border-b border-solid 
                        ...
                        <h3 className="text-3xl text-purple-600 font-semibold">{donate.title}</h3>
                ...
                <div className="relative p-6 flex-auto">
                    ...
                    <input onChange={(e)=> setAmount(e.target.value)} 
                           ...
                           className="flex-grow w-full h-12 px-4 mb-2 transition duration-200
                                     ...
                                     focus:border-purple-400 focus:outline-none text-purple-500 font-semibold
                                     focus:shadow-sm"
                            id="firstName"
                            name="firstName"    
                    /
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid
                    ...
                    <div className="font-semibold text-xl text-red-500">{amountError}</div>
                </div>
                </div>
            </div>                    
