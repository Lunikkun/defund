...
const Hero = ({ titleData, createCampaign }) => {
  ...
  return (
    <div className="relative">
      Hero
      <img
        src="https://wallpaperaccess.com/full/1267703.jpg"
            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                    <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                        DeFund <br className="hidden md:block"></br>
                        CrowdFunding
                    </h2>
                    <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                    DeFund is a decentralized crowdfunding platform on the Ethereum network, enabling users to create and fund campaigns directly, quickly, and securely using cryptocurrency
                    </p>
                ...
                <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                    <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                        <h3 className="mb-4 text-xl text-purple-700 font-semibold sm:text-center sm:mb-6 sm:text-2xl">
                        ...
                        <form>
                            <div className="mb-1 sm:mb-2">
                                ...
                                required
                                type="text"
                                className="flex-grow w-full h-12 px-4 mb-2 
                                transition dutaion-200 bg-white border border-gray-300 rounded shadow-sm 
                                appearance-none focus:border-purple-400 
                                focus:shadow-outline text-gray-500"
                                id="firstName"
                                name="firstName"
                                >
                                </input>
                            ...
                            <div className="mt-4 mb-2 sm:mb-4">
                                <button onClick={(e)=> createNewCampaign(e)}
                                        ...
                                        className="inline-flex items-center justify-center w-full h-12
                                                   ...
                                                   rounded shadow-md bg-purple-700 focus:shadow-sm focus:outline-none newColor"   
                                >
                                    Create Campaign
                                </button>
                            </div>
                            <p className="text-xs text-gray-600 sm:text-sm"> Create you Campaign to rise funds</p>
                        </form>
                    </div>                    
                </div>
            </div>
